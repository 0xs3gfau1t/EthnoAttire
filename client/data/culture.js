const cultureList = {
    0: {
        ...
        description: 'Hello guys, yo brahmin/chhetri ko description',
        ...
        origin: ['Parbat', 'Argakhanchi', 'Syangja', 'Chitwan', 'Kaski', 'Gulmi', 'Jhapa', 'Nawalpur']
    },
    1: {
        name: 'Newar',
        description: 'Ramri ramri nani haru',
        ...
        origin: ['Kathmandu', 'Bhaktapur', 'Patan']
    },
    2: {
        name: 'Tharu',
        description: 'Khatra dance',
        ...
        origin: ['Bara', 'Rautahat', 'Siraha', 'Saptari', 'Sunsari', 'Morang', 'Bardiya', 'Kailali', 'Kanchanpur', 'Banke', 'Kapilvastu', 'Rupendahi']
    },
    3: {
        name: 'Gurung',
        description: 'K cha Soltini',
        ...
        origin: ['Manang', 'Lamjung', 'Mustang', 'Gorkha', 'Kaski']
    },
    4: {
        name: 'Magar',
