const cultureList = {
    0: {
        ...
        description: `Brahmins and Chhetri most often are spread all over the country. Initially, the village houses were washed with red ochre or always cleaned with a fresh, wet mixture of cow dung and mud. They are mainly involved in government service, farming, and as a family priest. Brahmins are of two types: Purbiya and Kumain. The name Kumai derives from “Kumaon”. It is one of the districts of Northern India's Utter Pradesh State, to the west of Nepal.`,
    },
    1: {
        name: 'Newari',
